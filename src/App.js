...
import { NavBar, SideBar, ViewProfile, Document, Upload, Footer, Home, Versions, Edit } from './components';
          ...
          >
            ...
            <Router>
              <Routes>
                ...
                <Route element={<Edit setAlert={setAlert} setAlertContent={setAlertContent} />} path="/document/:id" />
