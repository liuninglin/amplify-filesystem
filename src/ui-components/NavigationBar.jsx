    ...
    >
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Logo31742870")}
        >
          <Icon
            width="18px"
            height="18px"
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="Logo"
            {...getOverrideProps(overrides, "Logo31742872")}
          ></Text>
        </Flex>
        <Button
          display="flex"
          ...
          variation="link"
          children="Home"
          {...getOverrideProps(overrides, "Button31742873")}
        ></Button>
        <Button
          display="flex"
          gap="0"
          ...
          variation="link"
          children="File"
          {...getOverrideProps(overrides, "Button31742874")}
        ></Button>
        <Button
          display="flex"
          gap="0"
          ...
          variation="link"
          children="Upload"
          {...getOverrideProps(overrides, "Button31742875")}
        ></Button>
        <Button
          display="flex"
          gap="0"
          ...
          variation="link"
          children="User"
          {...getOverrideProps(overrides, "Button31742876")}
        ></Button>
        <Button
          display="flex"
          gap="0"
          ...
          variation="link"
          children="MyProfile"
          {...getOverrideProps(overrides, "Button31742877")}
        ></Button>
        <Flex
          gap="300px"
          direction="row"
